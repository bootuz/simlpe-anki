...
export const CSP_CLIENT_DIRECTIVES = {
  'default-src': "'self' *.lovable.app *.lovable.dev *.sandbox.lovable.dev",
  'script-src': "'self' 'unsafe-inline' 'unsafe-eval' *.lovable.app *.lovable.dev *.sandbox.lovable.dev", // Allow inline for dev
...
export const CSP_SERVER_ONLY_DIRECTIVES = {
  'frame-ancestors': "'self' *.lovable.app *.lovable.dev *.sandbox.lovable.dev",
} as const;
