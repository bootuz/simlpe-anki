  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        {/* Static Flashcards */}
        {[
          { text: "Hola", subject: "Spanish", x: "5%", y: "15%", rotate: "-12deg", color: "bg-red-500/30 border-red-400" },
          { text: "Python", subject: "Programming", x: "88%", y: "12%", rotate: "15deg", color: "bg-blue-500/30 border-blue-400" },
          { text: "こんにちは", subject: "Japanese", x: "2%", y: "85%", rotate: "8deg", color: "bg-pink-500/30 border-pink-400" },
