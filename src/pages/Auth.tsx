...
import { BookOpen, Eye, EyeOff, Lock, Mail, CheckCircle, XCircle, Loader2, Sparkles } from "lucide-react";
...
const Auth = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-primary via-accent to-primary/20 animate-fade-in">
      <Card className="w-full max-w-md mx-auto bg-card/90 backdrop-blur-2xl border border-primary/30 shadow-[0_8px_32px_rgba(0,0,0,0.12),0_2px_16px_rgba(0,0,0,0.08)] before:absolute before:inset-0 before:rounded-lg before:p-[1px] before:bg-gradient-to-r before:from-primary/40 before:via-accent/30 before:to-primary/40 before:-z-10 relative overflow-hidden animate-scale-in hover:shadow-[0_12px_48px_rgba(0,0,0,0.15),0_4px_24px_rgba(0,0,0,0.1)] transition-all duration-500 hover-scale">
        <div className="absolute inset-0 bg-gradient-to-br from-card/50 via-transparent to-accent/5 pointer-events-none"></div>
        <CardHeader className="text-center relative z-10 animate-fade-in">
          <div className="flex items-center justify-center gap-2 mb-4 group">
            <BookOpen className="h-8 w-8 text-primary transition-all duration-300 group-hover:rotate-12 group-hover:scale-110" />
            <h1 className="text-2xl font-bold bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">Simple Anki</h1>
          </div>
            ...
            <TabsContent value="signin" className="animate-fade-in">
              <div className="space-y-4">
                <Button 
                  ...
                  variant="outline" 
                  className="w-full group transition-all duration-300 hover:bg-primary/5 hover:border-primary/30 hover:shadow-md"
                ...
                <form onSubmit={signInForm.handleSubmit(handleSignIn)} className="space-y-4 animate-fade-in">
                  <div className="space-y-2 group">
                    <Label htmlFor="signin-email" className="transition-colors group-focus-within:text-primary">Email</Label>
                    <div className="relative">
                  ...
                  <div className="space-y-2 group">
                    <Label htmlFor="signin-password" className="transition-colors group-focus-within:text-primary">Password</Label>
                    <div className="relative">
                  ...
                  <Button 
                    type="submit" 
                    className="w-full bg-gradient-to-r from-primary to-accent hover:from-primary/90 hover:to-accent/90 transition-all duration-300 hover:shadow-lg hover:scale-[1.02] disabled:hover:scale-100" 
            ...
            <TabsContent value="signup" className="animate-fade-in">
              <div className="space-y-4">
                ...
                <form onSubmit={signUpForm.handleSubmit(handleSignUp)} className="space-y-4 animate-fade-in">
                  <div className="space-y-2 group">
                    <Label htmlFor="signup-email" className="transition-colors group-focus-within:text-primary">Email</Label>
                    <div className="relative">
                      <Mail className="absolute left-3 top-3 h-4 w-4 text-muted-foreground transition-colors group-focus-within:text-primary" />
                      <Input
                        id="signup-email"
                  ...
                  <div className="space-y-2 group">
                    <Label htmlFor="signup-password" className="transition-colors group-focus-within:text-primary">Password</Label>
                    <div className="relative">
                      <Lock className="absolute left-3 top-3 h-4 w-4 text-muted-foreground transition-colors group-focus-within:text-primary" />
                      <PasswordInput
                        id="signup-password"
                  ...
                  <div className="space-y-2 group">
                    <Label htmlFor="confirm-password" className="transition-colors group-focus-within:text-primary">Confirm Password</Label>
                    <div className="relative">
                      <Lock className="absolute left-3 top-3 h-4 w-4 text-muted-foreground transition-colors group-focus-within:text-primary" />
                      <PasswordInput
                        id="confirm-password"
              ...
              <div className="space-y-4">
                {forgotPasswordSent ? (
                  <div className="text-center space-y-4 animate-scale-in">
                    <div className="mx-auto w-16 h-16 bg-gradient-to-br from-green-100 to-green-50 rounded-full flex items-center justify-center border-2 border-green-200 animate-fade-in">
                      <CheckCircle className="h-8 w-8 text-green-600 animate-scale-in" />
                    </div>
                    <div className="animate-fade-in">
                      <h3 className="text-lg font-medium bg-gradient-to-r from-green-600 to-green-500 bg-clip-text text-transparent">
                        Check your email
                      </h3>
                    ...
                    <Button 
                      ...
                      className="w-full transition-all duration-300 hover:bg-primary/5 hover:border-primary/30 hover:shadow-md hover:scale-[1.02]"
                    >
                      Send another email
                    </Button>
                  </div>
                  ...
                  <>
                    ...
                    <form onSubmit={forgotPasswordForm.handleSubmit(handleForgotPassword)} className="space-y-4 animate-fade-in">
                      <div className="space-y-2 group">
                        <Label htmlFor="forgot-email" className="transition-colors group-focus-within:text-primary">Email</Label>
                        <div className="relative">
                          <Mail className="absolute left-3 top-3 h-4 w-4 text-muted-foreground transition-colors group-focus-within:text-primary" />
                          <Input
                            id="forgot-email"
                        ...
                        {forgotPasswordForm.formState.errors.email && (
                          <p className="text-sm text-destructive animate-fade-in">{forgotPasswordForm.formState.errors.email.message}</p>
                        )}
                      </div>
