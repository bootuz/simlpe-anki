...
-- Create a security definer function instead that inherits RLS from underlying tables
-- This function will automatically respect RLS policies of the underlying tables
...
-- Create a simple view that calls the function for the current user
