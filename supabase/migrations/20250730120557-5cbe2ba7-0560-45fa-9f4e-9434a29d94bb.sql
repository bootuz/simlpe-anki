-- Critical security fixes for flashcard application

-- Phase 1: Fix SECURITY DEFINER views and add proper RLS
-- Drop existing views that have security issues
...
-- Fix search path security issue in function
